...
Open `c4model.dsl` (which pulls in the C3 fragment) in [structurizr.com/dsl](https://structurizr.com/dsl), `scripts/start-structurizr.sh`, or the Structurizr CLI for the interactive view. The C3 layer is validated by `C3ArchTest`:
