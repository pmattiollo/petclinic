...
public class ExceptionControllerAdvice {
    ...
    // Controllers signal an expected, client-caused failure with ResponseStatusException; without this handler the
    // catch-all Exception handler below would turn it into a 500.
    ...
    public ResponseEntity<ProblemDetail> handleResponseStatusException(ResponseStatusException ex, HttpServletRequest request) {
        ...
        pd.setProperty("errors", List.of(String.valueOf(ex.getReason())));
